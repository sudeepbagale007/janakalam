  ...
  Plugin.prototype = {
    ...
    defineElements: function() {
      ...
      if( _self.options.controllers.append !== false ){
        var resetButton = _self.options.controllers.showResetButton ? '<a href="#" class="rvfs-reset btn" title="Default font size">अ</a>' : '';
        ...
        if( $.trim(template).length > 0 ){
          ...
          controllersHtml = '<div class="btn-group">' +
                      '<a href="#" class="rvfs-decrease btn" title="Decrease font size">अ-</a></li>' +
                      resetButton +
                      '<a href="#" class="rvfs-increase btn" title="Increase font size">अ+</a></li>' +
                    '</div>';
        }
