														...
														<ul class="menu ui-sortable" id="menu-to-edit">
															...
															<li id="menu-item-{{$m->id}}" class="menu-item menu-item-depth-{{$m->depth}} menu-item-page menu-item-edit-inactive pending" style="display: list-item;">
																...
																<div class="menu-item-settings" id="menu-item-settings-{{$m->id}}">
																	...
																	<p class="field-css-classes description description-thin">
																		<label for="edit-menu-item-newtab-{{$m->id}}"> Open in New Tab
																			<br>
																			<input type="checkbox" id="newtab_menu_{{$m->id}}" class=" edit-menu-item-newtab" name="newtab_menu_{{$m->id}}" value="{{ $m->newtab }}" <?php echo (isset($m->newtab) && $m->newtab == '1')?'checked':'' ?> >
																		</label>
																	</p>
