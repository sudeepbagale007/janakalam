...
<div class="row">
    <div class="col-md-9">
        <div class="box box-info">
            @include('admin.dashboard.category_pie_chart')
        </div>
    </div>
    <div class="col-md-3">
        <div class="box box-info">
                    ...
                    <table class="table table-hover table-condensed dataTablePaginationSort compact">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $count++ }}</td>
                                <td>{{ $item->title}}</td>
                                <td class="text-center"><a href="{{ route('category.list',$item->slug) }}" target="_blank" title="{{ $item->title }}">{!! LINK_ICON !!}</a></td>
...
<div class="row">
    ...
    ?>
        <div class="col-md-6">
            <div class="box box-info">
            	<div class="box-header with-border">
            		<h3 class="box-title">{{ $item->title }} [Total News : <b>{{ number_format(count($item->totalpost)) }}</b>, Total Views : <b>{{ number_format($totalviews) }} </b>]</h3>
            	</div>
                <div class="box-body">
                    <div class="table-responsive">
                        <table class="table table-hover table-condensed dataTablePaginationSort compact">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="{{ route('post.detail',$itemx->slug) }}" target="_blank" title="{{ $itemx->title }}">{!! LINK_ICON !!}</a></td>
