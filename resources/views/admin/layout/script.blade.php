...
<script type="text/javascript" src="{{ asset('admin/plugins/datepicker/bootstrap-datepicker.min.js') }}"></script>
<script type="text/javascript" src="{{ asset('admin/assets/datetimepicker/js/bootstrap-datetimepicker.min.js') }}"></script>
