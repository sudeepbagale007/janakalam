                ...
                <div class="form-group">
                    ...
                    <select name="advertisement_id" id="advertisement_id" class="form-control">
                        ...
                        @foreach($advertisement_list as $kl => $item)
                            <option value="{{ $item->id }}" @if(old('advertisement_id') == $item->id) {{ 'selected' }} @endif>{{ $item->title }}</option>
                        @endforeach
                        @endif
                    </select>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control datetimepicker" id="start_time" name="start_time" value="{{ date('Y-m-d H:i') }}" >
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="control-label" for="end_time">Ad End Date Time <span class="text-danger">*</span></label>
                            <input type="text" class="form-control datetimepicker" id="end_time" name="end_time" value="{{ date('Y-m-d H:i') }}" >
                        </div>
                    </div>
                </div>
            </div>
